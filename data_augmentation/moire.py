...
class Moire:
    ...
    def add_moire_noise(self, src):
        ...
        degree = random.uniform(0.0008, 0.01)
...
if __name__ == "__main__":
    import time
    img_org = cv2.imread('/data/datasets/thainq/sonnt373/dev/FAS/dev/cvpr2024-face-anti-spoofing-challenge/data_preprocess/face_parsing/datatest/image_T1.jpg')
    moire = Moire()
    for _ in range(20):
        t0 = time.time()
        img = moire(img_org)
